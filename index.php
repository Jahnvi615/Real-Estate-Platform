...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <div class="overlay-black w-100 slider-banner1 position-relative" style="background-image: url('images/banner.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        <div class="text-white">
                            <h1 class="mb-4">
                            	<span class="text-primary">Find</span><br>
                                Your Dream Office / Flats</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                <i class="fas fa-home text-primary flat-medium" aria-hidden="true"></i>

                                <h5 class="text-secondary hover-text-primary py-3 m-0"><a href="#">Selling Service</a></h5>
                                <p>Unlock your dream property with our expert real estate services, offering personalized guidance and market insights for the best deal.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                <i class="fas fa-tags text-primary flat-medium" aria-hidden="true"></i>

                                <h5 class="text-secondary hover-text-primary py-3 m-0"><a href="#">Rental Service</a></h5>
                                <p>Find your ideal rental home with our expert real estate services, providing personalized guidance and tailored solutions for a perfect match.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                <i class="fas fa-list-ul text-primary flat-medium" aria-hidden="true"></i>

                                <h5 class="text-secondary hover-text-primary py-3 m-0"><a href="#">Property Listing</a></h5>
                                <p>Explore a diverse range of properties with our comprehensive listings, designed to help you find your ideal home or investment opportunity.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                <i class="fas fa-chart-pie text-primary flat-medium" aria-hidden="true"></i>

                                <h5 class="text-secondary hover-text-primary py-3 m-0"><a href="#">Legal Investment</a></h5>
                                <p>Maximize your returns with our legal investment services, offering expert advice and secure opportunities for sound financial growth.</p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            ...
                                            <?php echo timeAgo($row['date']); // Output the time difference ?>
                                            </div>
                                            <br>
                                            <center>
        ...
        <!--    Why Choose Us -->
        <div class="full-row living bg-one overlay-secondary-half" style="background-image: url('images/why.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container">
                <div class="row">
                        ...
                        <div class="living-list pr-4">
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
                                    ...
                                    <div class="pl-2">
                                        <h5 class="mb-3">Expertise You Can Trust</h5>
                                        <p>At Jahnvi Estates, we bring years of experience and a commitment to quality in every project, ensuring top-tier real estate services.</p>
                                    </div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
                                    ...
                                    <div class="pl-2">
                                        ...
                                        <p>Located at Ajmer,Rajasthan,we’re easily accessible and well-versed in the local market.</p>
                                    </div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
                                    <i class="flaticon-seller flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
                                    <div class="pl-2">
                                        <h5 class="mb-3">Quality & Reliability</h5>
                                        <p>We are known for delivering properties that offer long-term value, backed by our transparent and reliable service. Trust Jahnvi Estates to make your real estate journey seamless.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <div class="left-arrow"><i class="fas fa-user-tie flat-medium icon-primary" aria-hidden="true"></i>
                        </div>
                            <h5 class="text-secondary mt-5 mb-4">Property Discussion</h5>
                            <p>We begin by understanding your property needs. Whether you're buying, selling, or renting, our agents will discuss location preferences, budget, and property features to find the best match for you.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            <div class="bg-primary text-white rounded-circle position-absolute z-index-9">2</div>
                            <div class="left-arrow"><i class="fas fa-search flat-medium icon-primary" aria-hidden="true"></i>
                        </div>
                            <h5 class="text-secondary mt-5 mb-4">Property Inspection & Review</h5>
                            <p>Once we have identified a few properties that meet your requirements, we organize property visits. Our team will assist you in reviewing important details such as legal paperwork, amenities, and the condition of the property.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            <div class="bg-primary text-white rounded-circle position-absolute z-index-9">3</div>
                            <div><i class="fas fa-handshake flat-medium icon-primary" aria-hidden="true"></i>
                           </div>
                            <h5 class="text-secondary mt-5 mb-4">Acquire Property</h5>
                            <p>After the selection and review process, we move towards finalizing the deal. Our experts will guide you through the payment process, contract signing, and legal formalities to ensure a smooth transaction.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!--    Achievement
        ============================================================-->
        <div class="full-row overlay-secondary" style="background-image: url('images/banner1.avif'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container">
                <div class="fact-counter">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="fas fa-home flat-large text-white" aria-hidden="true"></i>
                        ...
                        <div class="col-md-3">
                            <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="fas fa-user flat-large text-white" aria-hidden="true"></i>
            ...
            <div class="container">
                ...
                <div class="col-lg-12">
                    <div class="row">-->
                        ...
                        <!--<div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/ithum3.jpg" height="500"alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/ithum.jpg" height="500" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/ithum2.jpg" height="500" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
            ...
            <div class="col-lg-12">
                <div class="content-sidebar p-4">
                    <div class="mb-3 col-lg-12">
                        <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4">Our Client Reviews</h4>
                        <div class="recent-review owl-carousel owl-dots-gray owl-dots-hover-primary">

                            <?php
                            // Fetch all feedback records from the database
                            $query = mysqli_query($con, "SELECT feedback.*, user.* FROM feedback JOIN user ON feedback.uid = user.uid");
                                    ...
                                    <div class="item">
                                        <div class="p-4 bg-primary down-angle-white position-relative">
                                            <p class="text-white">
                                                ...
                                                <?php echo htmlspecialchars($row['fdescription']); ?>.
