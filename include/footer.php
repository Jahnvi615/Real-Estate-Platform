    ...
    <div class="container">
        <div  class="row">
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="footer-widget mb-4">
                                <div class="footer-logo mb-4"> 
                                    <a href="#"><img class="logo-bottom" src="images/logo/jahvi.png" height="90" width="90"  alt="image"></a>
                                </div>

                                <p class="pb-20 text-white">Jahnvi Estate is a real estate company known for premium property developments. They operate from Ajmer,Rajasthan, focusing on creating modern, sustainable residential and commercial spaces with high-quality construction.</p>

								<p class="pb-20 text-white"> The company is committed to timely delivery and customer satisfaction.</p>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-4">
                                    <div class="footer-widget">
                                        ...
                                        <ul class="text-white">
                                            <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i><a href="https://maps.app.goo.gl/LfNzhvGm91ZDwC3q7" style="color:#fff;">Ajmer,Rajasthan</a></li>
                                            <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+91 90798 78526</li>
											<li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+91 90798 78526</li>
                                            <li class="hover-text-primary"><i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>xyz@gmail.com</li>
                                        </ul>
                                    </div>
            ...
            <div class="row copyright">
                <div class="col-sm-6"> <span class="text-white">© 2024 Jahnvi Estate All right reserved</span> </div>
                    <div class="col-sm-6">
