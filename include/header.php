<style>
/* Adjust the logo positioning for mobile screens */
@media only screen and (max-width: 768px) {

    .navbar-brand img {
        width: 90px; /* Adjust the logo size for mobile */
        height: auto;
        margin-left: -150px;
    }
}
...
<header id="header" class="transparent-header-modern fixed-header-bg-white w-100">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="top-contact list-text-white  d-table">
                                <li><a href="#"><i class="fas fa-phone-alt text-primary mr-1"></i>+91 90798 78526</li>
                                <li><a href="#"><i class="fas fa-envelope text-primary mr-1"></i>xyz@gmail.com</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
            ...
            <div class="main-nav secondary-nav hover-primary-nav py-2">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <nav class="navbar navbar-expand-lg navbar-light p-0"> <a class="navbar-brand position-relative" href="#"><img class="nav-logo" src="images/logo/jahvi.png" height="70" width="100" alt="" style="border-radius: 30%;"></a>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    ...
                                    <a class="btn btn-primary d-none d-xl-block" href="submitproperty.php">Listing Property</a> 
