...
<div id="page-wrapper">
	<div class="row"> 
				...
				<div class="row">
							...
							<ul>
								<li class="d-flex mb-4">
									...
									<div class="contact-address">
										...
										<span class="text-secondary" style="color: white !important;">Ajmer , </span> 
										<span class="text-secondary" style="color: white !important;">Rajasthan</span>
									</div>
								</li>
								...
								<li class="d-flex mb-4">
									...
									<div class="contact-address">
										...
										<span class="d-table text-secondary" style="color: white !important;">+91 90798 78526</span>
										<span class="text-secondary" style="color: white !important;" >++91 90798 78526</span>
									</div>
								</li>
								<li class="d-flex mb-4">
									...
									<div class="contact-address">
										...
										<span class="d-table text-secondary" style="color: white !important;">xyz@gmail.com</span>
									</div>
								</li>
							</ul>
						</div>
					...
					<div class="col-md-12 col-lg-7">
						<div class="container">
							<div class="row">
								<div class="col-lg-12">
									<h2 class="text-secondary double-down-line text-center mb-5">Contact Us</h2>
		...
		<!-- Map -->
		<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d114306.49103824802!2d74.55331221140281!3d26.45321956796727!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396be6d8fcb7cd01%3A0xcbaf8f12eb8100ee!2sAjmer%2C%20Rajasthan!5e0!3m2!1sen!2sin!4v1726462932619!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
		<!-- Map -->
		...
		<!-- Scroll to top --> 
		<a href="#" class="bg-secondary text-white hover-text-primary" id="scroll"><i class="fas fa-angle-up"></i></a> 
	</div>
</div>
